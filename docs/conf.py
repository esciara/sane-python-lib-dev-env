...
# -----------------------------------------------------------------------------
project = "sane-python-lib-dev-env"
package_name = "sane-python-lib-dev-env"
...
extlinks = {
    ...
    "issue": (f"https://github.com/esciara/{project}/issue/%s", "issue #"),
    "youtube": ("https://www.youtube.com/watch?v=%s", "youtube:video="),
    package_name: (f"https://github.com/esciara/{project}", None),
}
...
# (some variables already set in PRE-GENERAL CONFIGURATION section)
# -----------------------------------------------------------------------------
description = "An attempt to define tools and practices for a sane Python " \
...
latex_documents = [
    ("index", f"{package_name}.tex", title, authors, "manual")
]
...
man_pages = [("index", package_name, title, [authors], 1)]
